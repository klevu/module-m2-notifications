...
use Klevu\Notifications\Controller\Adminhtml\Notification\Unmute;
...
/**
 * @covers Unmute::class
 * @method Unmute instantiateTestObject(?array $arguments = null)
 * @method Unmute instantiateTestObjectFromInterface(?array $arguments = null)
 */
class UnmuteTest extends AbstractBackendControllerTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = Unmute::class;
    ...
    public function testExecute(): void
    {
        ...
        $this->dispatch(
            uri: $this->getAdminFrontName()
                . '/klevu_notifications/notification/unmute/id/'
                . $notification->getId(),
        );
        ...
        $this->assertFalse($notificationReloaded->isMuted());
    }
}
